...
public sealed class MaterialArbitrageTest
{
    ...
    [
        ...
        "SheetRGlass1", "ChemistryEmptyBottle01", "WarmLightBulb", "ColdLightBulb", "UvLightTube", "SodiumLightBulb" // imp add uv light & cold lightbulb and sodium light bulb(oops)
    ];
